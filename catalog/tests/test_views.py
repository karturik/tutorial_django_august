...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(resp, '/user/accounts/login/?next=/catalog/mybooks/')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        login = self.client.login(username='testuser2', password='12345')
        invalid_date_in_past = datetime.date.today() - datetime.timedelta(days=1)
        resp = self.client.post(reverse('renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk}), {'renewal_date':invalid_date_in_past})
        self.assertEqual(resp.status_code, 200)
